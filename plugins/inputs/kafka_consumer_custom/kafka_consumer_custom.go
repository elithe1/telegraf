...
func (k *KafkaConsumer) Description() string {
	return "Read metrics from Kafka cust topics"
}
...
func (h *ConsumerGroupHandler) Setup(sarama.ConsumerGroupSession) error {
	log.Print("III!! [inputs.kafka_consumer_cust] Hi it's me welcome")
...
func init() {
	...
	inputs.Add("kafka_consumer_custom", func() telegraf.Input {
